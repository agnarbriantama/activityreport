					...
					<div class="col-xl-6 col-sm-6 mb-3">
						<div class="card text-white bg-primary o-hidden h-100">
							<div class="card-body">
								...
								<div class="mr-10 mb-5">
									<h4>Data Pantauan Yang Tercatat : <?php echo $this->db->count_all('tb_laporanharian'); ?></h4>
								</div>
							</div>
							<a class="card-footer text-white clearfix small z-1" href="<?php echo site_url('admin/LaporanHarian/index') ?>">
								<span class="float-left">Lihat Lebih Detail</span>
								<span class="float-right">
									<i class="fas fa-angle-right"></i>
								</span>
